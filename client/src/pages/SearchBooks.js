...
const SearchBooks = () => {
  const searchGoogleBooks = (query) => { return fetch(`https://www.googleapis.com/books/v1/volumes?q=${query}`); };
  ...
  useEffect(() => { return () => saveBookIds(savedBookIds); }); //useEffect hook to save `savedBookIds`
